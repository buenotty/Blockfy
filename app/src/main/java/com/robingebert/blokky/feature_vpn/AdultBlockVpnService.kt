package com.robingebert.blokky.feature_vpn
...
import com.robingebert.blokky.feature_monitor.InterruptActivity
...
class AdultBlockVpnService : VpnService() {
    ...
    private fun notifyAdultBlock(host: String?) {
        ...
        lastAlertAt = now
        val quote = AdultContentDetector.getRandomWarning()
